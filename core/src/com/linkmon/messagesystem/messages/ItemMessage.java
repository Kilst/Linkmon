...
public class ItemMessage extends MessageBox {
	...
	public ItemMessage(String messageString, WorldRenderer worldRenderer1, EventManager eManager) {
		...
		this.add(backbutton).align(Align.right).size(backbutton.getWidth()*WorldRenderer.scaleXY, backbutton.getHeight()*WorldRenderer.scaleXY);
