...
//				MyScrollPane.this.visualAmountX = 180;
//				MyScrollPane.this.amountX = 180;
//				
//				MyScrollPane.this.lastPoint.set(180, y);
				
				//scrollTo(5*240+80, MyScrollPane.this.getY(), MyScrollPane.this.getWidth()-220, 220);
...
//				Gdx.app.log("MyScrollPane", "TouchUp heard!");
//				velocityX = 0;
//				if(amountX < 450) {
//					scrollTo(0, MyScrollPane.this.getY(), 1080-60, 0, true, false);
//				}
//				
//				else if(amountX <= (1080-60)*2 && amountX >= 450) {
//					scrollTo(1080-60, MyScrollPane.this.getY(), (1080-60)*2, 0, true, false);
//				}
//			}
		...
		flickScrollListener = new ActorGestureListener() {
			...
			public void touchUp (InputEvent event, float x, float y, int pointer, int button) {
				Gdx.app.log("MyScrollPane fling", "TouchUp heard!");
				velocityX = 1;
				if(amountX < 550) {
					scrollTo(0, MyScrollPane.this.getY(), 1080-60, 0);
				}
				
				else if(amountX <= (1080-60)*1.4 && amountX >= 550) {
					scrollTo(1080-60, MyScrollPane.this.getY(), 1080-60, 0);
				}
				else
					scrollTo((1080-60)*2, MyScrollPane.this.getY(), 1080-60, 0);
			}
...
//			}
	 ...
	 * @author mzechner
	 * @author Nathan Sweet */
	static public class MyScrollPaneStyle {
		/** Optional. */
		...
		public MyScrollPaneStyle () {
		}

		public MyScrollPaneStyle (Drawable background, Drawable hScroll, Drawable hScrollKnob, Drawable vScroll, Drawable vScrollKnob) {
		...
		public MyScrollPaneStyle (ScrollPaneStyle style) {
