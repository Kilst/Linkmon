...
public class TopLayerInput implements GestureListener {
private EventManager eManager;
	...
	public TopLayerInput(EventManager eManager, GameClass game) {
...
//		Gdx.app.log("InputController", "touchDown");
		...
		eManager.notify(new ScreenEvent(ScreenEvents.ADD_PARTICLE_EFFECT, ParticleIds.TAP, point.x, point.y));
